    ...
    <div style="margin: 30px auto" class="calculatorContainer">
        <div class="flex">
            <div class="left-side">
                ...
                <div class="inputs">
                    <div>
                        <label for="laborTime" style="text-align: center">Labor Time (Hours)</label>
                    ...
                    <div>
                        <label for="rate" style="text-align: center">Hourly Rate ($)</label>
                        <div class="input-icon-container">
                    ...
                    <div>
                        <label for="margin" style="text-align: center">Desired Profit Margin (%)</label>
                        <div class="input-icon-container">
